        ...
        <div className="min-h-screen bg-background">
            <div className="relative py-24 px-6 text-center overflow-hidden flex items-center justify-center min-h-[40vh]">
                ...
                <div className="relative z-10">
                    <span className="text-clay font-bold tracking-widest uppercase text-xs mb-3 block">
                        Stories form the Roots
                    </span>
                    <h1 className="text-5xl font-bold font-serif text-white mb-8">
                        Bharat Bazaar Blog
                    </h1>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <Link
                    href="/blog/stories"
                    className="group relative h-96 rounded-3xl overflow-hidden hover:scale-[1.02] transition-transform"
                >
                    <img
                        src="https://images.unsplash.com/photo-1596395191799-239401737e6f?auto=format&fit=crop&q=80&w=800"
                        alt="Craft Stories"
                ...
                >
                    <img
                        src="https://images.unsplash.com/photo-1574679727653-b3c99026d30d?auto=format&fit=crop&q=80&w=800"
                        alt="Culture"
                        className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
